...
// @version    0.0.0
// @icon       https://t0.gstatic.com/faviconV2?client=SOCIAL&type=FAVICON&fallback_opts=TYPE,SIZE,URL&url=http://youtube.com&size=256
...
(function() {
	...
	_css("*{box-sizing:border-box;margin:0;padding:0}.search-popup{z-index:1000;background:#212121;border:1px solid #3a3a3a;border-radius:16px;width:650px;max-width:90vw;padding:16px;position:fixed;top:20%;left:50%;transform:translate(-50%);box-shadow:0 16px 40px #00000080,0 0 0 1px #ffffff08}.search-header{align-items:center;gap:12px;margin-bottom:14px;display:flex}.search-text{color:#fff;font-family:Roboto,Arial,sans-serif;font-size:14px;font-weight:500}.input-search{color:#fff;background:#121212;border:1px solid #3a3a3a;border-radius:12px;outline:none;width:100%;height:52px;padding:0 18px;font-family:Roboto,Arial,sans-serif;font-size:18px;transition:border-color .15s}.input-search:focus{border-color:#3ea6ff}.input-search::placeholder{color:#888}.search-results{flex-direction:column;gap:6px;margin-top:12px;display:flex}.result-item{color:#fff;cursor:pointer;border-radius:10px;padding:12px 16px}.result-item:hover{background:#2d2d2d}");
	...
	function App() {
		...
		(0, import_react.useEffect)(() => {
			...
			function handleKeyDown(e) {
				if (e.code == "KeyK" && e.metaKey) setShowPopup(!showPopup);
